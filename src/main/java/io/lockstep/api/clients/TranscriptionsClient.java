...
public class TranscriptionsClient
{
     ...
     */
    public @NotNull LockstepResponse<TranscriptionValidationRequest> retrieveTranscriptionValidationRequest(@NotNull String id, @Nullable String include)
    {
        RestRequest<TranscriptionValidationRequest> r = new RestRequest<TranscriptionValidationRequest>(this.client, "GET", "/api/v1/Transcriptions/validate/{id}");
        r.AddPath("{id}", id.toString());
        r.AddQuery("include", include.toString());
        return r.Call(TranscriptionValidationRequest.class);
    }
     ...
     * @return A {@link io.lockstep.api.LockstepResponse} containing the results
     */
    public @NotNull LockstepResponse<TranscriptionValidationRequest> updateTranscriptionValidationRequest(@NotNull String id, @NotNull Object body)
    {
        RestRequest<TranscriptionValidationRequest> r = new RestRequest<TranscriptionValidationRequest>(this.client, "PATCH", "/api/v1/Transcriptions/validate/{id}");
        r.AddPath("{id}", id.toString());
        r.AddBody(body);
        return r.Call(TranscriptionValidationRequest.class);
    }
     ...
     * @return A {@link io.lockstep.api.LockstepResponse} containing the results
     */
    public @NotNull LockstepResponse<TranscriptionValidationRequest> createTranscriptionValidationRequest(@NotNull TranscriptionRequestSubmit[] body)
    {
        RestRequest<TranscriptionValidationRequest> r = new RestRequest<TranscriptionValidationRequest>(this.client, "POST", "/api/v1/Transcriptions/validate");
        r.AddBody(body);
        return r.Call(TranscriptionValidationRequest.class);
    }
     ...
     * @return A {@link io.lockstep.api.LockstepResponse} containing the results
     */
    public @NotNull LockstepResponse<FetchResult<TranscriptionValidationRequest>> queryTranscriptionValidationRequests(@Nullable String filter, @Nullable String include, @Nullable String order, @Nullable Integer pageSize, @Nullable Integer pageNumber)
    {
        RestRequest<FetchResult<TranscriptionValidationRequest>> r = new RestRequest<FetchResult<TranscriptionValidationRequest>>(this.client, "GET", "/api/v1/Transcriptions/validate/query");
        r.AddQuery("filter", filter.toString());
        r.AddQuery("include", include.toString());
        r.AddQuery("order", order.toString());
        r.AddQuery("pageSize", pageSize.toString());
        r.AddQuery("pageNumber", pageNumber.toString());
        return r.Call(new TypeToken<FetchResult<TranscriptionValidationRequest>>() {}.getType());
    }
}
