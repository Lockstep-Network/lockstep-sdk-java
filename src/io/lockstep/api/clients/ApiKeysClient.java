...
public class ApiKeysClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/ApiKeys/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<ApiKeyModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/ApiKeys/{id}");
        r.AddPath("{id}", id);
        return this.client.Request<ApiKeyModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/ApiKeys");
        r.AddBody(body);
        return this.client.Request<ApiKeyModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/ApiKeys/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<ApiKeyModel>>(r);
    }
}
