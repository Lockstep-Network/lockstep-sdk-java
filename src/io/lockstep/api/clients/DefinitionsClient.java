...
public class DefinitionsClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Definitions/countries");
        ...
        return this.client.Request<FetchResult<CountryModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Definitions/currencies");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<CurrencyModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Definitions/states");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<StateModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Definitions/financialsystems");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<ErpModel>>(r);
    }
}
