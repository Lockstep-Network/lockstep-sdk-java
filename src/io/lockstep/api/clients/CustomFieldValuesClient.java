...
public class CustomFieldValuesClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/CustomFieldValues/{definitionId}/{recordKey}");
        r.AddPath("{definitionId}", definitionId);
        r.AddPath("{recordKey}", recordKey);
        r.AddQuery("include", include);
        return this.client.Request<CustomFieldValueModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/CustomFieldValues/{definitionId}/{recordKey}");
        r.AddPath("{definitionId}", definitionId);
        r.AddPath("{recordKey}", recordKey);
        r.AddBody(body);
        return this.client.Request<CustomFieldValueModel>(r);
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/CustomFieldValues/{definitionId}/{recordKey}");
        r.AddPath("{definitionId}", definitionId);
        r.AddPath("{recordKey}", recordKey);
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/CustomFieldValues");
        r.AddBody(body);
        return this.client.Request<CustomFieldValueModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/CustomFieldValues/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<CustomFieldValueModel>>(r);
    }
}
