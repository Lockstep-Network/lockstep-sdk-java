...
public class AttachmentsClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Attachments/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<AttachmentModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/Attachments/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<AttachmentModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/Attachments/{id}");
        r.AddPath("{id}", id);
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Attachments/{id}/download");
        r.AddPath("{id}", id);
        return this.client.Request<UriModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/Attachments");
        r.AddQuery("tableName", tableName);
        r.AddQuery("objectId", objectId);
        return this.client.Request<AttachmentModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Attachments/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<AttachmentModel>>(r);
    }
}
