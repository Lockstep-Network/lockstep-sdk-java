...
public class AppEnrollmentsClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/AppEnrollments/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<AppEnrollmentModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/AppEnrollments/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<AppEnrollmentModel>(r);
    }
     ...
     */
    public LockstepResponse<ActionResultModel> DeleteAppEnrollment(String id)
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/AppEnrollments/{id}");
        r.AddPath("{id}", id);
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/AppEnrollments");
        r.AddBody(body);
        return this.client.Request<AppEnrollmentModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/AppEnrollments/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<AppEnrollmentModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/AppEnrollments/settings/{id}");
        r.AddPath("{id}", id);
        return this.client.Request<FetchResult<AppEnrollmentCustomFieldModel>>(r);
    }
}
