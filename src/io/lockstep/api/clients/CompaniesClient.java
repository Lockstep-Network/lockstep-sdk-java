...
public class CompaniesClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Companies/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<CompanyModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/Companies/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<CompanyModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/Companies/{id}");
        r.AddPath("{id}", id);
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/Companies");
        r.AddBody(body);
        return this.client.Request<CompanyModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Companies/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<CompanyModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Companies/views/customer-summary");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<CustomerSummaryModel>>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Companies/views/customer-details/{id}");
        r.AddPath("{id}", id);
        return this.client.Request<CustomerDetailsModel>(r);
    }
}
