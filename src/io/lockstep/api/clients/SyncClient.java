...
public class SyncClient
{
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/Sync");
        r.AddBody(body);
        return this.client.Request<SyncRequestModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/Sync/zip");
        return this.client.Request<SyncRequestModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/Sync/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<SyncRequestModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Sync/{id}");
        r.AddPath("{id}", id);
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Sync/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<SyncRequestModel>>(r);
    }
}
