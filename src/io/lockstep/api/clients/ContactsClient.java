...
public class ContactsClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Contacts/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<ContactModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/Contacts/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<ContactModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/Contacts/{id}");
        r.AddPath("{id}", id);
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/Contacts");
        r.AddBody(body);
        return this.client.Request<ContactModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Contacts/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<ContactModel>>(r);
    }
}
