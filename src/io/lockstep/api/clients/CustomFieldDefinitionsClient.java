...
public class CustomFieldDefinitionsClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/CustomFieldDefinitions/{id}");
        r.AddPath("{id}", id);
        r.AddQuery("include", include);
        return this.client.Request<CustomFieldDefinitionModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("PATCH", "/api/v1/CustomFieldDefinitions/{id}");
        r.AddPath("{id}", id);
        r.AddBody(body);
        return this.client.Request<CustomFieldDefinitionModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("DELETE", "/api/v1/CustomFieldDefinitions/{id}");
        r.AddPath("{id}", id);
        return this.client.Request<CustomFieldDefinitionModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("POST", "/api/v1/CustomFieldDefinitions");
        r.AddBody(body);
        return this.client.Request<CustomFieldDefinitionModel[]>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/CustomFieldDefinitions/query");
        r.AddQuery("filter", filter);
        r.AddQuery("include", include);
        r.AddQuery("order", order);
        r.AddQuery("pageSize", pageSize);
        r.AddQuery("pageNumber", pageNumber);
        return this.client.Request<FetchResult<CustomFieldDefinitionModel>>(r);
    }
}
