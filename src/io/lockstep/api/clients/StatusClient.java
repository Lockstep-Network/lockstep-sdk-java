...
public class StatusClient
{
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Status");
        return this.client.Request<StatusModel>(r);
    }
    ...
    {
        RestRequest r = new RestRequest("GET", "/api/v1/Status/testing");
        r.AddQuery("err", err);
        return this.client.Request<TestTimeoutException>(r);
    }
}
